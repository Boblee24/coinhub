...
const Reason = () => {
  return (
    <div className='m-4 md:my-8 md:mb-[9rem]'>
        <div className=''>
            <h4 className='text-[#2196F3] text-center font-semibold md:text-[24px]'>Why choose Tradiant ?</h4>
        ...
        <div className='flex flex-col flex-wrap md:flex-row md:items-center justify-center md:justify-center md:my-6'>
            <div className='m-3 md:max-w-[400px] '>
                <div className='bg-[#F5F5F5] md:h-[260px] md:w-full md:flex md:items-center md:justify-center' ><img src={Images.firstcard}alt='firstcard'/></div>
            ...
            <div className='m-3 md:max-w-[400px] '>
                <div className='bg-[#F5F5F5] md:h-[260px] md:w-full md:flex md:items-center md:justify-center'><img src={Images.secondcard}alt='secondcard'/></div>
                <div className='reason_flex_note'>
            ...
            <div className='m-3 md:max-w-[400px] '>
                <div className='bg-[#F5F5F5] p-3  md:h-[260px] md:w-full md:flex md:items-center md:justify-center'> <img className='' src={Images.thirdcard}alt='thirdcard'/></div>
                <div className='reason_flex_note'>
