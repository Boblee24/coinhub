  ...
  return (
      <div className='blog_hero_note relative bg-no-repeat bg-cover h-[100dvh] mb-5 p-0 bg-center' style={{backgroundImage: `url(${Images.blog_hero})`}}>
          <div className='flex justify-center flex-col h-full p-2'>
            <div>
              <h4 className='text-[#2196F3] font-[Poppins]'>Market Update</h4>
              <h2 className=' text-5xl my-3 leading-[3.5rem] fomt-[Epilogue] text-[2.5rem]'  >Take note! This is the important point for Bitcoin price to strengthen again</h2>
