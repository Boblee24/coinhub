...
const ABOUT_HERO = () => {
  ...
  return (
    <div className="about-hero relative bg-no-repeat bg-cover h-[100dvh] m-0 p-0 bg-center" style={{backgroundImage:  `url(${Images.about_hero2})`}}>
      <div className="about_hero_note flex justify-right items-center h-full p-2 xs:p-[3%] z-20">
      <div className='max-w-md'>
        <h2 className="py-3 leading-[3rem] text-[2.3rem] font-[Epilogue] font-[700] text-black">GlobaL Market Leader</h2>
