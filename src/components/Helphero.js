        ...
        <div className="about_hero_note flex justify-right items-center h-full p-2 z-20">
          <div className='max-w-md'>
              ...
              <label className="relative block my-3">
                ...
                <input className="placeholder:italic  placeholder:text-slate-400 block bg-white w-[50%] border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="Search for anything..." type="text" name="search"/>
              </label>
          </div>
        </div>
    </div>
