  ...
  return (
    <div className='partner m-2 '>
        <div className='partner_note text-center'>
            <h3 className='font-[Epilogue] text-[1.6rem] font-bold md:text-[40px]'>A trading partner you can trust</h3>
            <p className='text-[.9rem] md:text-[1rem]'>At Tradiant, we rigorously focus on quality and transparency. Our order execution quality is independently monitored. Order execution with high quality means: you save money with every investment you make with Tradiant.</p>
        </div>
        <div className='partners my-5 flex justify-between flex-col items-center text-center md:flex-row md:gap-[10%] md:mx-[5%]'>
