        ...
        <div className='flex flex-col logo_links md:flex-row md:justify-between '>
            ...
            <div className='md:flex md:justify-between md:w-full'> 
                <ul className='flex justify-center flex-col py-7 md:py-0 items-start font-[Poppins] md:flex-row md:justify-around md:w-[60%] md:ml-[3%] md:items-center'>
                    <li onClick={scrollToTop()} className='w-[40%] md:w-auto  text-[#485967] '><NavLink  className='flex md:text-[.8rem]'  to="/about" onClick={props.handleHarmbugerclick}>About</NavLink></li>
                    <li onClick={scrollToTop()} className='w-[40%] md:w-auto  text-[#485967] '><NavLink  className='flex md:text-[.8rem]'  to="/why_us" onClick={props.handleHarmbugerclick}>Why Us?</NavLink></li>
                    <li onClick={scrollToTop()} className='w-[40%] md:w-auto  text-[#485967] '><NavLink  className='flex md:text-[.8rem]'  to="/blog" onClick={props.handleHarmbugerclick}>Blog</NavLink></li>
                    <li onClick={scrollToTop()} className='w-[40%] md:w-auto  text-[#485967] '><NavLink  className='flex md:text-[.8rem]'  to="/journey" onClick={props.handleHarmbugerclick}>Journey</NavLink></li>
                    <li onClick={scrollToTop()} className='w-[40%] md:w-auto  text-[#485967] '><NavLink  className='flex md:text-[.8rem]'  to="/help" onClick={props.handleHarmbugerclick}>Help</NavLink></li>
                </ul>
