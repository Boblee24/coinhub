...
const WHY_US_WHY_US = () => {
  return (
    <div className=' my-6 sm:my-[4%]'>
        <div className='m-3 sm:my-[3%]'>
            <div className='flex flex-col gap-4 my-4 sm:flex-row-reverse sm:items-center sm:gap-[4%]'>
                <div className=''>
                    <video width="640" height="360" className="video-js vjs-default-skin vjs-big-play-centered rounded-lg w-[640px] h-[360px] sm:min-w-[400px] sm:min-h-[350px] object-cover"controls src= './video1.mp4' type="video/mp4"></video>
                </div>
            ...
            <div className='flex flex-col gap-4 my-4] sm:flex-row sm:items-center sm:gap-[4%]'>
                <div className=''>
                    <video width="640" height="360" className="video-js vjs-default-skin vjs-big-play-centered rounded-lg w-[640px] h-[360px] sm:min-w-[400px] sm:min-h-[350px] object-cover"controls src= './video2.mp4' type="video/mp4"></video>
                </div>
                <div className='sm:w-7/12'>
                    <h4 className='font-[Poppins] text-[1.1rem] font-[500] text-[#2196F3]'>WHY US??</h4>
